  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-5 justify-center">
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-3xl font-bold text-white">Bhavya Bansal</h3>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email: <span className="text-lightText">your_email@gmail.com</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Github: <span className="text-lightText">https://github.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-0">
        ...
        <div className="flex gap-4">
          ...
          <span className="bannerIcon">
          <a href="https://www.linkedin.com/in/bhavya-bansal98/" target="_blank" rel="noopener noreferrer">
            <FaLinkedinIn /></a>
          </span>
        </div>
      </div>
